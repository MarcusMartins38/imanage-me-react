      ...
      >
        ...
        <div className="menu p-2 !pt-0 h-full">
          ...
          <div className="absolute mb-2 bottom-0 w-full">
            <label
              className={`menu-item justify-start w-full h-10 swap swap-rotate rounded-lg px-1 transition-all ${isOpen ? "max-w-60" : "max-w-12 justify-center"} duration-300 hover:bg-base-300`}
            >
              <input
                type="checkbox"
