...
function Tasks() {
  ...
  return (
    <main>
      <div className="p-4">
        {tasks.map((task) => (
          <div className="card bg-base-200 rounded-box flex flex-row h-min-20 h-auto place-items-center p-4 my-4">
            ...
            <section className="flex flex-row items-center gap-x-2">
              <button className="btn bg-base-300 border-base-300 hover:bg-blue-500 hover:text-white">
                <svg
              ...
              <button className="btn bg-base-300 border-base-300 hover:bg-red-500 hover:text-white">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
                  viewBox="0 0 24 24"
